...
public class DBMockup {
    ...
    public boolean register(String u, String p) throws IOException {
        if (!exists(u, p)) {
            users.add(new User(u, p));
                ...
                try (BufferedWriter bw = new BufferedWriter(new FileWriter("C:\\Users\\migue\\Documents\\NetBeansProjects\\SD\\src\\edu\\ufp\\inf\\sd\\rmi\\diglib\\ServerDB\\UsersRegisted.txt"))) {
                ...
                try (BufferedWriter bw = new BufferedWriter(new FileWriter("C:\\Users\\migue\\Documents\\NetBeansProjects\\SD\\src\\edu\\ufp\\inf\\sd\\rmi\\diglib\\ServerDB\\NumUsers.txt"))) {
                ...
                subjects.add(peim);
                new File("C:\\Users\\migue\\Documents\\NetBeansProjects\\SD\\src\\edu\\ufp\\inf\\sd\\rmi\\diglib\\ServerDB\\"+u).mkdirs();
          return true;
        }
    return false;
    ...
    {
        try (BufferedWriter bw = new BufferedWriter(new FileWriter("C:\\Users\\migue\\Documents\\NetBeansProjects\\SD\\src\\edu\\ufp\\inf\\sd\\rmi\\diglib\\ServerDB\\Permissoes.txt"))) {
...
public boolean removePerms(String user,String subUser) throws IOException
    ...
    public int numUsers()
    {
        In in = new In("C:\\Users\\migue\\Documents\\NetBeansProjects\\SD\\src\\edu\\ufp\\inf\\sd\\rmi\\diglib\\ServerDB\\NumUsers.txt");    
    ...
    public ArrayList<ArrayList<String>> readAllPerm()
    {
        ...
        int numPerm;
        In in = new In("C:\\Users\\migue\\Documents\\NetBeansProjects\\SD\\src\\edu\\ufp\\inf\\sd\\rmi\\diglib\\ServerDB\\Permissoes.txt");
    ...
    public void lerUsers() throws RemoteException{
        ...
        int numUsers= numUsers();
        In in = new In("C:\\Users\\migue\\Documents\\NetBeansProjects\\SD\\src\\edu\\ufp\\inf\\sd\\rmi\\diglib\\ServerDB\\UsersRegisted.txt");
