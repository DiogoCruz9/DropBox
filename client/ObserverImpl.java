...
public class ObserverImpl implements ObserverRI {
    ...
    public static final String PATH_TO_SERVERS = ""; 
    ...
    public void update() throws RemoteException {
        ...
        if(!this.lastObsState.toString().equals(this.subjectRI.getState().toString())){
            ...
            String path= "C:\\Users\\migue\\Documents\\NetBeansProjects\\SD\\src\\edu\\ufp\\inf\\sd\\rmi\\diglib\\ClientFiles\\"+clientUserName+"\\"+observerUserName+"\\"+this.lastObsState.getFileName();
        ...
        {
            deleteFolder("C:\\Users\\migue\\Documents\\NetBeansProjects\\SD\\src\\edu\\ufp\\inf\\sd\\rmi\\diglib\\ClientFiles\\"+clientUserName+"\\"+observerUserName+"\\"+this.lastObsState.getFileName());
        }
    }
    ...
    {
        String path= "C:\\Users\\migue\\Documents\\NetBeansProjects\\SD\\src\\edu\\ufp\\inf\\sd\\rmi\\diglib\\ClientFiles\\"+clientUserName+"\\"+observerUserName+"\\"+fileName;
        createFolder(path);
    }
