    ...
    private void playService(String [] args) throws InterruptedException {
        ...
        try {
            ...
            case "login":
                    ...
                    {
                        File file = new File("C:\\Users\\migue\\Documents\\NetBeansProjects\\SD\\src\\edu\\ufp\\inf\\sd\\rmi\\diglib\\ClientFiles\\"+username+"\\"+subPermissions.get(i));
                        if(!file.exists())
                        {
                            file.mkdir();
                        }
                        ...
                        sessionRI.updateDirectory(subPermissions.get(i),subjectRI,username,sizeOfFiles, listOfFiles);
                    }
                ...
                case "register":
                    ...
                    {
                        new File("C:\\Users\\migue\\Documents\\NetBeansProjects\\SD\\src\\edu\\ufp\\inf\\sd\\rmi\\diglib\\ClientFiles\\"+args[4]+"\\"+args[4]).mkdirs();
                        System.out.println("\nREGISTADO\n");
                    }
                    else
                    {
