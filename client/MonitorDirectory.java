...
public class MonitorDirectory implements Runnable {
        ...
        public void teste() throws RemoteException
        {
            ...
            try(WatchService service = FileSystems.getDefault().newWatchService()){
                ...
                Path path= Paths.get("C:\\Users\\migue\\Documents\\NetBeansProjects\\SD\\src\\edu\\ufp\\inf\\sd\\rmi\\diglib\\ClientFiles\\"+clientUserName+"\\"+observerUserName);
                ...
                do {     
                    ...
                    for(WatchEvent<?> event : watchKey.pollEvents())
                    {
                        ...
                        File file = new File("C:\\Users\\migue\\Documents\\NetBeansProjects\\SD\\src\\edu\\ufp\\inf\\sd\\rmi\\diglib\\ClientFiles\\"+clientUserName+"\\"+observerUserName+"\\"+eventPath);
